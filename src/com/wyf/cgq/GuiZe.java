...
public class GuiZe {
	...
	public void ju(int maxI, int minI, int maxJ, int minJ) {// 对"車"的处理方法
	...
	public void xiang2(int maxI, int minI, int maxJ, int minJ, int startI, int startJ, int endI, int endJ) {// 对"象"的处理
		int a = maxI - minI;
		int b = maxJ - minJ;// 获得X,Y坐标的差
		if (a == 2 && b == 2) {// 如果是"田"字
			if (endJ < 5) {// 如果过河了
	...
	public void jiang(int maxI, int minI, int maxJ, int minJ, int startI, int startJ, int endI, int endJ) {// 对"帥"、"將"的处理
		int a = maxI - minI;
		int b = maxJ - minJ;// 获得X,Y坐标的差
	...
	public void pao(int maxI, int minI, int maxJ, int minJ, int startI, int startJ, int endI, int endJ) {// 对"炮"、"砲"的处理
		if (maxI == minI) {// 如果走的竖线
		...
		} else if (maxJ != minJ && maxI != minI) {// 如果走的既不是竖线，也不是横线，则不可以走
			canMove = false;
		}
	}
	...
	public void zu(int maxI, int minI, int maxJ, int minJ, int startI, int startJ, int endI, int endJ) {// 对"卒"的处理
		if (startJ > 4) {// 如果还没有过河
			if (startI != endI) {// 如果不是向前走
				canMove = false;// 不可以走
			}
